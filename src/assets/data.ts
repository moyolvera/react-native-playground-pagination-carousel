...
const data: SliceList = [
  {
    type: 'Humlan P',
    imageUri: require('./urbanears_blue.png'),
  ...
  {
    type: 'Pampas',
    imageUri: require('./urbanears_pink.png'),
  ...
  {
    type: 'Humlan P',
    imageUri: require('./urbanears_grey.png'),
  ...
  {
    type: 'Humlan B',
    imageUri: require('./urbanears_mint.png'),
    heading: 'From Sweden',
